...
class LinkedList:
    ...
    def append( self, value ):
        nuevo = Nodo (value)
        if self.__head == None:  ## NOTE: self.is.empty()
			self.__head = nuevo
        else:
	...
	def get( self , posicion=None ): ## NOTE: Por defecto regresa el ultimo
		contador = 0
		dato = None
		if posicion == None:
			dato = self.tail().data
